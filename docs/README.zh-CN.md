...
<p align="center">
  <strong>基于 Rust + Tauri 2 构建的统一接码工具</strong>
</p>
...
**码到（MaDao）**，是一款基于 Rust + Tauri2 构建的统一接码工具，整合 HeroSms、5Sim、SMSBower 多平台资源，支持按服务类型、国家、运营商灵活配置取码方案，并通过匿名聚合统计帮助用户找到成功率最高的国家与线路组合，告别盲目试错。
