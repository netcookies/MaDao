...
export function SectionHeader(props: SectionHeaderProps) {
  ...
  return (
    <div className="flex items-start justify-between gap-ds-lg max-[760px]:flex-col">
      <div className="flex min-w-0 items-start gap-ds-md">
        ...
        <div className="flex min-w-0 flex-col">
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            <h2 className="m-0 font-display text-page-title font-semibold tracking-[var(--ds-type-page-title-tracking)] text-ds-text-primary">
              {title}
            </h2>
            {badge}
          </div>
