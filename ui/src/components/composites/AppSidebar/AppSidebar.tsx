...
export function AppSidebar<T extends string>(props: AppSidebarProps<T>) {
  ...
  return (
    <aside className={cx(
      'flex h-full flex-col bg-ds-sidebar backdrop-blur-ds transition-[width] duration-fast ease-[var(--ds-motion-transition-fast)] min-[980px]:overflow-y-auto min-[980px]:border-r min-[980px]:border-black/5',
