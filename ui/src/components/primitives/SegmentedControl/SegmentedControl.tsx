...
const ROOT_RAIL_CLASS = 'inline-flex flex-nowrap items-center gap-1 rounded-[8px] border border-white/25 bg-white/[31%] p-1 backdrop-blur-[12px] shadow-[0_1px_3px_rgba(0,0,0,0.07)]';
