...
const ROOT_RAIL_CLASS = 'inline-flex flex-nowrap items-center gap-1 rounded-[8px] bg-[#e5e5ea] p-1';
...
const ITEM_RAIL_ACTIVE_CLASS = 'bg-white text-ds-text-primary shadow-[0_1px_2px_rgba(0,0,0,0.10)]';
